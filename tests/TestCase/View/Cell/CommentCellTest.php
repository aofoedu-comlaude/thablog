...
use App\View\Cell\CommentCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\CommentCell Test Case
 */
class CommentCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Comment = new CommentCell($this->request, $this->response);
    }
